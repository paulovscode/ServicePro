...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private boolean isPublicEndpoint(HttpServletRequest request) {
        ...
        return path.startsWith("/api/auth/") ||
            ...
            path.equals("/api/prestadores") && request.getMethod().equals("POST") ||
            path.equals("/api/prestadores/login") ||
            path.equals("/api/servicos/teste") ||
            path.startsWith("/api/servicos/health") ||
            path.equals("/status");
    }
}
